# Description: The ego vehicle attempts a left turn at a suburban intersection and gets struck on its side by an oncoming truck traveling straight. The ego should have waited for the truck to pass before turning left, resulting in a severe collision with critical injuries to the ego driver.
